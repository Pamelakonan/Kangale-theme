...
class SponsoMetabox{
    ...
    const MONCE = '_montheme_sponso_nonce'; 
...
if($postType === 'post' && current_user_can('publish_post',$post)){
    ...
    public static function render ($post){
        ...
        ?>
 <input type="hidden" name="o" name="<?= self:: META_KEY ?>">
<input type="checkbox" name="1" name="<?= self:: META_KEY ?>" <?php   checked($value === '1' )?>>
 <label for="monthemesponso"> Cet article est sponrise ?</label>
